...
namespace Icebreaker.Helpers.AdaptiveCards
{
    ...
    public static class PairUpNotificationAdaptiveCard
    {
        ...
        private static readonly List<string> ConversationStarters = new List<string>()
            {
        ...
        public static string GetCard(string teamName, TeamsChannelAccount sender, TeamsChannelAccount recipient, string botDisplayName)
        {
            ...
            var matchUpCardContentPart1 = string.Format(Resources.MatchUpCardContentPart1, recipient.Name);
            var matchUpCardContentPart2 = Resources.MatchUpCardContentPart2;
            var matchUpCardConversationStarterTitle = Resources.MatchUpCardConversationStarterTitle;
            ...
            var formattedMatchUpCardConversationStarter = GetFormattedConversationStarter();
            var variablesToValues = new Dictionary<string, string>()
            {
                ...
                { "matchUpCardConversationStarterTitle", matchUpCardConversationStarterTitle },
                { "matchUpCardConversationStarter", formattedMatchUpCardConversationStarter },
        ...
        /// <summary>
        /// Creates a formatted string with three conversation starters.
        /// </summary>
        /// <returns>A formatted string including newlines.</returns>
        private static string GetFormattedConversationStarter()
        {
            ...
            do
            {
                randomIndex1 = random.Next(ConversationStarters.Count);
                randomIndex2 = random.Next(ConversationStarters.Count);
                randomIndex3 = random.Next(ConversationStarters.Count);
            } while ((randomIndex1 == randomIndex2) || (randomIndex2 == randomIndex3) || (randomIndex1 == randomIndex3));
            var formattedMatchUpCardConversationStarter = $"* {ConversationStarters[randomIndex1]}\n\n* {ConversationStarters[randomIndex2]}\n\n* {ConversationStarters[randomIndex3]}";
            return formattedMatchUpCardConversationStarter;
        }
